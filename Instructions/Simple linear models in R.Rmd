...
make sure you have the data. Try to plot it
...
for bewteen group means, knowing one group mean and the grand mean you can calculate the 2nd
...
4. use this new data frame to predict values of contraction rate that are at different concentrations than
used in the experiment by `predict(modelname,new)`. Hint, you will get funny error messages if your new data has a different variable name to that in your model.
